            ...
            <div class="card-header">
                <div class="row">
                    <div class="col col-lg-2">
                        <h5 class="m-0">Editar Plantación</h5>
                    </div>

                </div>
            </div>
            <div class="card-body">
                <form action="{{url('plantacion/actualizar/'.$plantacion->id)}}" method="post">
                @csrf
                    ...
                    <div class="card-body row col-sm-12 col-md-8 col-lg-8">
                        ...
                        <div class="form-group col col-sm-12 col-md-6 col-lg-6">
                            ...
                            <input type="text" class="form-control" name="tiporiego" value="{{$plantacion->tiporiego}}">
                        </div>
                        <div class="form-group col col-sm-12 col-md-6 col-lg-6">
                            <label for="exampleInputPassword1">Tipo de Abono</label>
                            <input type="text" class="form-control" name="tipoabono" value="{{$plantacion->tipoabono}}">
                        </div>
                        <div class="form-group col col-sm-12 col-md-6 col-lg-6">
                            <label for="exampleInputEmail1">Plantines por Hectareas</label>
                            <input type="number" class="form-control" name="cantidadplantine_ha"required min="0" max="999999" value="{{$plantacion->cantidadplantine_ha}}">
                        </div>
                        <div class="form-group col col-sm-12 col-md-6 col-lg-6">
                            <label for="exampleInputPassword1">Extension en Hectareas</label>
                            <input type="number" class="form-control" name="extencion_ha"required min="0" max="999999" value="{{$plantacion->extencion_ha}}">
                        </div>
                        <div class="form-group col col-sm-12 col-md-6 col-lg-6">
                            <label for="exampleInputPassword1">Fecha de Plantacion</label>
                            <input type="date" class="form-control" name="fechaplantacion" value="{{$plantacion->fechaplantacion}}">
                        </div>
                    </div>
                </div>
                    <!-- /.card-body -->
