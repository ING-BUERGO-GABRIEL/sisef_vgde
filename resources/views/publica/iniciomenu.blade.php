...
<div class="page"><a class="section section-banner d-none d-xl-block" href="https://www.facebook.com/IngenieriaEnSistemasFivc" style="background-image: url({{asset('images/banner/background-04-1920x60.jpg')}}); background-image: -webkit-image-set( url({{asset('images/banner/background-04-1920x60.jpg')}}) 1x, url({{asset('images/banner/background-04-3840x120.jpg')}}) 2x )"><img src="{{asset('images/banner/foreground-04-1600x60.png')}}" srcset="{{asset('images/banner/foreground-04-1600x60.png')}} 1x, {{asset('images/banner/foreground-04-3200x120.png')}} 2x" alt="" width="1600" height="310"></a>
    <!-- Page Header-->
                        ...
                        <div class="rd-navbar-main-element">
                            <div class="rd-navbar-nav-wrap">
                                ...
                                <ul class="rd-navbar-nav">
                                    <li class="rd-nav-item"><a class="rd-nav-link" href="{{url('publica/home')}}">Inicio</a>
                                    </li>
                                    <li class="rd-nav-item"><a class="rd-nav-link" href="{{url('publica/tipos')}}">Tipos</a>
                                    </li>
                                    <li class="rd-nav-item"><a class="rd-nav-link" href="{{url('publica/estadis')}}">Datos</a>                              
                                    </li>
...
<script src="{{asset('libs/morris.min.js')}}" charset="utf-8"></script>
<script src="http://cdnjs.cloudflare.com/ajax/libs/raphael/2.1.0/raphael-min.js"></script>
<script src="https://cdn.jsdelivr.net/npm/chart.js@2.8.0"></script>
<script src="{{asset('libs/linea.js')}}"></script>
@yield('scripts')
</body>
</html>