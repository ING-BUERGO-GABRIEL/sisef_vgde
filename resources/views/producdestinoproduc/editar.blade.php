            ...
            <div class="card-header">
                <div class="row">
                    <div class="col col-lg-2">
                        <h5 class="m-0">Editar Destino Producción</h5>
                    </div>

                </div>
            </div>
            <div class="card-body">
                <form action="{{url('producdestinoproduc/actualizar/'.$producdestinoproduc->id)}}" method="post">
                @csrf
                     <div class="card-body row">
                        ...
                        <div class="form-group col col-lg-6">
                            ...
                            <input type="number" class="form-control" name="porsentaje_destinado" placeholder="porsentaje_destinado" required min="1" max="100" value="{{$producdestinoproduc->porsentaje_destinado}}">
                        </div>
                    </div>
                    <!-- /.card-body -->
