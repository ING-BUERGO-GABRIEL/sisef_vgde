            ...
            <div class="col-md-12 col-lg-12 col-xl-12">
              ...
              <div class="tabs-custom tabs-horizontal tabs-line" id="tabs-4">
                <ul class="nav nav-tabs">
                  <li class="nav-item" role="presentation"><a class="nav-link" href="<?php echo e(url('estadistica')); ?>">Barras</a></li>
                  <li class="nav-item" role="presentation"><a class="nav-link" href="<?php echo e(url('estadistica/lineas')); ?>">Lineas</a></li>
                  <li class="nav-item" role="presentation"><a class="nav-link active" href="#" data-toggle="tab">Torta</a></li>
                </ul>
                <!-- Tab panes-->
                       ...
                       <div class="tabs-custom tabs-horizontal tabs-line" id="tabs-5">
                         ...
                         <div class="tab-content">
                           <div class="tab-pane fade show active" id="tabs-5-1">
                             ...
                             <div class="row justify-content-center" ><h4>Descripcion</h4></div>
                           </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('publica.iniciomenu', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sisefvgde\resources\views/estadis/torta.blade.php ENDPATH**/ ?>