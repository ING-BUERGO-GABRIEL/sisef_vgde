                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="oh-desktop">
                        ...
                        <article class="thumbnail thumbnail-mary thumbnail-sm wow slideInLeft" data-wow-delay="0s">
                            ...
                            <div class="thumbnail-mary-caption"><a class="icon fl-bigmug-line-zoom60" href="<?php echo e(asset('images/gallery-original-11-1200x800.jpg')); ?>" data-lightgallery="item"><img src="<?php echo e(asset('images/grid-gallery-11-370x303.jpg')); ?>" alt="" width="370" height="303"/></a>
...
<?php echo $__env->make('publica.iniciomenu', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sisef_vgde\resources\views/publica/inicio.blade.php ENDPATH**/ ?>