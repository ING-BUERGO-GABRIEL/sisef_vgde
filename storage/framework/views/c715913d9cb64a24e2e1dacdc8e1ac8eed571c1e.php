            ...
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col col-lg-10 ">
                        <a href="<?php echo e(url('fenomenoclima/create')); ?>" type="button"
            ...
            <div class="card-body">
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td>
                        <form id="eliminar<?php echo e($data->id); ?>" action="<?php echo e(url('/fenomenoclima/delete/'.$data->id)); ?>" method="post">
                                <?php echo csrf_field(); ?>
                                <a href="<?php echo e(url('fenomenoclima/'.$data->id.'/edit')); ?>" class="btn btn-outline-warning btn-sm">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('inicio.inicio', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sisefvgde\resources\views/fenomenoclima/inicio.blade.php ENDPATH**/ ?>